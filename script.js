...
function setLang(flag, name) {
  var cur = document.querySelector('.lang-current');
  if (cur) {
    cur.querySelector('.flag').textContent = flag;
    cur.querySelector('.lang-name').textContent = name;
  }
  var menu = document.getElementById('langMenu');
  if (menu) {
  ...
  try {
    applyLang((typeof I18N_MAP !== 'undefined' && I18N_MAP[name]) || 'en');
  } catch (e) {}
}
